Wordpress Auto-Installer is a script for cPanel/WHM that will automate a Wordpress install and setup. This script works on the detection of a specific cPanel package, and once selected it will automatically install Wordpress to that account.
